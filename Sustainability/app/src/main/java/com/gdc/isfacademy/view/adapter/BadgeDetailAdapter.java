        ...
        if (badgeStudentResponses.get(position).getBadgesType().equalsIgnoreCase(AppConstants.ID_ENERGY_SAVING)) {
            ...
            if (badgeStudentResponses.get(position).getValue() != null) {
                ...
                if (value < AppConstants.VALUE_ENERGY_SAVING_BRNOZE) {
                    ...
                    holder.seekBarText.setText("" + valueCheck + "/" + AppConstants.VALUE_ENERGY_SAVING_BRNOZE);
                    ...
                    float valueCheck = new BigDecimal(badgeStudentResponses.get(position).getValue()).setScale(1, BigDecimal.ROUND_HALF_UP).floatValue();
                    holder.seekBarText.setText("" + valueCheck + "/" + AppConstants.VALUE_ENERGY_SAVING_SILVER);
                    ...
                    float valueCheck = new BigDecimal(badgeStudentResponses.get(position).getValue()).setScale(1, BigDecimal.ROUND_HALF_UP).floatValue();
                    holder.seekBarText.setText("" + valueCheck + "/" + AppConstants.VALUE_ENERGY_SAVING_GOLD);
                    ...
                    float valueCheck = new BigDecimal(badgeStudentResponses.get(position).getValue()).setScale(1, BigDecimal.ROUND_HALF_UP).floatValue();
                    holder.seekBarText.setText("" + valueCheck + "/" + AppConstants.VALUE_ENERGY_SAVING_HIDDEN);
            ...
            if (badgeStudentResponses.get(position).getValue() != null) {
                ...
                if (value < AppConstants.VALUE_QUIZHOLIC_BRONZE) {
                    ...
                    float valueCheck = new BigDecimal(badgeStudentResponses.get(position).getValue()).setScale(1, BigDecimal.ROUND_HALF_UP).floatValue();
                    holder.seekBarText.setText("" + valueCheck + "/" + AppConstants.VALUE_QUIZHOLIC_BRONZE);
                    ...
                    float valueCheck = new BigDecimal(badgeStudentResponses.get(position).getValue()).setScale(1, BigDecimal.ROUND_HALF_UP).floatValue();
                    holder.seekBarText.setText("" + valueCheck + "/" + AppConstants.VALUE_QUIZHOLIC_SILVER);
                    ...
                    float valueCheck = new BigDecimal(badgeStudentResponses.get(position).getValue()).setScale(1, BigDecimal.ROUND_HALF_UP).floatValue();
                    holder.seekBarText.setText("" + valueCheck + "/" + AppConstants.VALUE_QUIZHOLIC_GOLDE);
                    ...
                    float valueCheck = new BigDecimal(badgeStudentResponses.get(position).getValue()).setScale(1, BigDecimal.ROUND_HALF_UP).floatValue();
                    holder.seekBarText.setText("" + valueCheck + "/" + AppConstants.VALUE_QUIZHOLIC_HIDDEN);
            ...
            if (value < AppConstants.VALUE_PERSISTANT_BRONZE) {
                ...
                float valueCheck = new BigDecimal(badgeStudentResponses.get(position).getValue()).setScale(1, BigDecimal.ROUND_HALF_UP).floatValue();
                holder.seekBarText.setText("" + valueCheck + "/" + AppConstants.VALUE_PERSISTANT_BRONZE);
                ...
                float valueCheck = new BigDecimal(badgeStudentResponses.get(position).getValue()).setScale(1, BigDecimal.ROUND_HALF_UP).floatValue();
                holder.seekBarText.setText("" + valueCheck + "/" + AppConstants.VALUE_PERSISTANT_SILVER);
                ...
                float valueCheck = new BigDecimal(badgeStudentResponses.get(position).getValue()).setScale(1, BigDecimal.ROUND_HALF_UP).floatValue();
                holder.seekBarText.setText("" + valueCheck + "/" + AppConstants.VALUE_PERSISTANT_GOLD);
                ...
                float valueCheck = new BigDecimal(badgeStudentResponses.get(position).getValue()).setScale(1, BigDecimal.ROUND_HALF_UP).floatValue();
                holder.seekBarText.setText("" + valueCheck + "/" + AppConstants.VALUE_PERSISTANT_HIDDEN);
            ...
            if (value < AppConstants.VALUE_PERFECTION_BRONZE) {
                ...
                float valueCheck = new BigDecimal(badgeStudentResponses.get(position).getValue()).setScale(1, BigDecimal.ROUND_HALF_UP).floatValue();
                holder.seekBarText.setText("" + valueCheck + "/" + AppConstants.VALUE_PERFECTION_BRONZE);
                ...
                float valueCheck = new BigDecimal(badgeStudentResponses.get(position).getValue()).setScale(1, BigDecimal.ROUND_HALF_UP).floatValue();
                holder.seekBarText.setText("" + valueCheck + "/" + AppConstants.VALUE_PERFECTION_SILVER);
                ...
                float valueCheck = new BigDecimal(badgeStudentResponses.get(position).getValue()).setScale(1, BigDecimal.ROUND_HALF_UP).floatValue();
                holder.seekBarText.setText("" + valueCheck + "/" + AppConstants.VALUE_PERFECTION_GOLD);
                ...
                float valueCheck = new BigDecimal(badgeStudentResponses.get(position).getValue()).setScale(1, BigDecimal.ROUND_HALF_UP).floatValue();
                holder.seekBarText.setText("" + valueCheck + "/" + AppConstants.VALUE_PERFECTION_HIDDEN);
            ...
            if (value < AppConstants.VALUE_BROADCASTER_BRONZE) {
                ...
                float valueCheck = new BigDecimal(badgeStudentResponses.get(position).getValue()).setScale(1, BigDecimal.ROUND_HALF_UP).floatValue();
                holder.seekBarText.setText("" + valueCheck + "/" + AppConstants.VALUE_BROADCASTER_BRONZE);
                ...
                float valueCheck = new BigDecimal(badgeStudentResponses.get(position).getValue()).setScale(1, BigDecimal.ROUND_HALF_UP).floatValue();
                holder.seekBarText.setText("" + valueCheck + "/" + AppConstants.VALUE_BROADCASTER_SILVER);
                ...
                float valueCheck = new BigDecimal(badgeStudentResponses.get(position).getValue()).setScale(1, BigDecimal.ROUND_HALF_UP).floatValue();
                holder.seekBarText.setText("" + valueCheck + "/" + AppConstants.VALUE_BROADCASTER_GOLD);
                ...
                float valueCheck = new BigDecimal(badgeStudentResponses.get(position).getValue()).setScale(1, BigDecimal.ROUND_HALF_UP).floatValue();
                holder.seekBarText.setText("" + valueCheck + "/" + AppConstants.VALUE_BROADCASTER_HIDDEN);
            ...
            if (value < AppConstants.VALUE_FRIENDLY_BRONZE) {
                ...
                float valueCheck = new BigDecimal(badgeStudentResponses.get(position).getValue()).setScale(1, BigDecimal.ROUND_HALF_UP).floatValue();
                holder.seekBarText.setText("" + valueCheck + "/" + AppConstants.VALUE_FRIENDLY_SILVER);
                ...
                float valueCheck = new BigDecimal(badgeStudentResponses.get(position).getValue()).setScale(1, BigDecimal.ROUND_HALF_UP).floatValue();
                holder.seekBarText.setText("" + valueCheck + "/" + AppConstants.VALUE_FRIENDLY_GOLD);
                ...
                float valueCheck = new BigDecimal(badgeStudentResponses.get(position).getValue()).setScale(1, BigDecimal.ROUND_HALF_UP).floatValue();
                holder.seekBarText.setText("" + valueCheck + "/" + AppConstants.VALUE_FRIENDLY_HIDDEN);
            ...
            if (value < AppConstants.VALUE_LEGENDARY_BRONZE) {
                ...
                float valueCheck = new BigDecimal(badgeStudentResponses.get(position).getValue()).setScale(1, BigDecimal.ROUND_HALF_UP).floatValue();
                holder.seekBarText.setText("" + valueCheck + "/" + AppConstants.VALUE_LEGENDARY_BRONZE);
                ...
                float valueCheck = new BigDecimal(badgeStudentResponses.get(position).getValue()).setScale(1, BigDecimal.ROUND_HALF_UP).floatValue();
                holder.seekBarText.setText("" + valueCheck + "/" + AppConstants.VALUE_LEGENDARY_SILVER);
                ...
                float valueCheck = new BigDecimal(badgeStudentResponses.get(position).getValue()).setScale(1, BigDecimal.ROUND_HALF_UP).floatValue();
                holder.seekBarText.setText("" + valueCheck + "/" + AppConstants.VALUE_LEGENDARY_GOLD);
                ...
                float valueCheck = new BigDecimal(badgeStudentResponses.get(position).getValue()).setScale(1, BigDecimal.ROUND_HALF_UP).floatValue();
                holder.seekBarText.setText("" + valueCheck + "/" + AppConstants.VALUE_LEGENDARY_HIDDEN);
            ...
            if (value < AppConstants.VALUE_SUPERIOR_SPECLIST_BRONZE) {
                ...
                float valueCheck = new BigDecimal(badgeStudentResponses.get(position).getValue()).setScale(1, BigDecimal.ROUND_HALF_UP).floatValue();
                holder.seekBarText.setText("" + valueCheck + "/" + AppConstants.VALUE_SUPERIOR_SPECLIST_BRONZE);
                ...
                float valueCheck = new BigDecimal(badgeStudentResponses.get(position).getValue()).setScale(1, BigDecimal.ROUND_HALF_UP).floatValue();
                holder.seekBarText.setText("" + valueCheck + "/" + AppConstants.VALUE_SUPERIOR_SPECLIST_SILVER);
                ...
                float valueCheck = new BigDecimal(badgeStudentResponses.get(position).getValue()).setScale(1, BigDecimal.ROUND_HALF_UP).floatValue();
                holder.seekBarText.setText("" + valueCheck + "/" + AppConstants.VALUE_SUPERIOR_SPECLIST_GOLD);
                ...
                float valueCheck = new BigDecimal(badgeStudentResponses.get(position).getValue()).setScale(1, BigDecimal.ROUND_HALF_UP).floatValue();
                holder.seekBarText.setText("" + valueCheck + "/" + AppConstants.VALUE_SUPERIOR_SPECLIST_HIDDEN);
            ...
            if (value < AppConstants.VALUE_CHAMPION_BRONZE) {
                ...
                float valueCheck = new BigDecimal(badgeStudentResponses.get(position).getValue()).setScale(1, BigDecimal.ROUND_HALF_UP).floatValue();
                holder.seekBarText.setText("" + valueCheck + "/" + AppConstants.VALUE_CHAMPION_BRONZE);
                ...
                float valueCheck = new BigDecimal(badgeStudentResponses.get(position).getValue()).setScale(1, BigDecimal.ROUND_HALF_UP).floatValue();
                holder.seekBarText.setText("" + valueCheck + "/" + AppConstants.VALUE_CHAMPION_SILVER);
                ...
                float valueCheck = new BigDecimal(badgeStudentResponses.get(position).getValue()).setScale(1, BigDecimal.ROUND_HALF_UP).floatValue();
                holder.seekBarText.setText("" + valueCheck + "/" + AppConstants.VALUE_CHAMPION_GOLD);
                ...
                float valueCheck = new BigDecimal(badgeStudentResponses.get(position).getValue()).setScale(1, BigDecimal.ROUND_HALF_UP).floatValue();
                holder.seekBarText.setText("" + valueCheck + "/" + AppConstants.VALUE_CHAMPION_HIDDEN);
