...
public class LocationUtils implements LocationListener, GoogleApiClient.ConnectionCallbacks {
    ...
    public LocationUtils(Context context, Activity activity,boolean isFromLogin) {
             ...
             TedPermission.with(mContext)
                    .setPermissionListener(new PermissionListener() {
                        ...
                        public void onPermissionDenied(ArrayList<String> deniedPermissions) {
                            ...
                            if(isFromLogin){
                                ((LoginActivity)mContext).showLoginDialog(mContext);
                            }
                        }
                    })
                ...
                googleApiClient = new GoogleApiClient.Builder(context)
                        ...
                        .addOnConnectionFailedListener(new GoogleApiClient.OnConnectionFailedListener() {
                            ...
                            public void onConnectionFailed(ConnectionResult connectionResult) {
                                ProjectUtil.showLog("TAG" + "", "Location error " + connectionResult.getErrorCode(),
                                        AppConstants.DEBUG_LOG);
                            }
                        }).build();
                            ...
                            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                ...
                                try {
                                    status.startResolutionForResult(
                                            (Activity) context, AppConstants.REQUEST_LOCATION);
...
//ISF requires your permisiion for anylativs perpose
    public void afterGettingLatLong(Double lat, Double lng, Context context) {
        try {
            if (lat != null && lng != null) {
                ...
                ProjectUtil.showLog("Lat and Long is",""+lat+"  "+"  "+lng,AppConstants.ERROR_LOG);
                if(activity instanceof LoginActivity){
                    ((LoginActivity) context).navigate(lat,lng,isFromLogin);
                }
