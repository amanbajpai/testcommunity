...
public class AppConstants {
    ...
    public static String getContent() {
        ...
        return "<!doctype html>\n" +
                ...
                "    </ol>\n" +
                "    <p>A maximum of 1,200 points can be earned per day, per person.</p>\n" +
                "  </section>\n" +
    ...
    public static String getGlossary() {
        ...
        return "<!doctype html>\n" +
                ...
                "  <section class=\"section-two\">\n" +
                "    <h2>kW</h2>\n" +
                "    <p>kW means kilowatt which is 1,000 Watts. It is a measure of power. </p>\n" +
                "    \n" +
                "  </section>\n" +
                "  <section class=\"section-three\">\n" +
                "    <h2>kWh (coming soon)</h2>\n" +
                "    <p>kWh stands for kilowatt-hour. A kWh is a measure of energy, not power. </p>\n" +
                "  </section>\n" +
                "    <section class=\"section-four\">\n" +
                "    <h2>Carbon footprint</h2>\n" +
                "    <p>This is the amount of carbon dioxide released into the atmosphere based on the activities of an individual or organisation.</p>\n" +
                "  </section>\n" +
                "  \n" +
                "   <section class=\"section-five\">\n" +
                "    <h2>Microgrid</h2>\n" +
                ...
                "  \n" +
                "    <section class=\"section-nine\">\n" +
                "    <h2>Electricity usage of 6 classrooms</h2>\n" +
                "   \n" +
                "  </section>\n" +
                "  </section>\n" +
                "  \n" +
                ...
                "    \n" +
                "    <section class=\"section-eleven\">\n" +
                "    <h2>Electricity from the grid</h2>\n" +
                "   \n" +
                "    </section>\n" +
                "  <section class=\"section-img\">\n" +
